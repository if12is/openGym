...
export default function Login() {
  ...
  const head = <>
    ...
    <h1 style={{ fontSize: 34, fontWeight: 800, letterSpacing: 0, margin: '10px 0 4px' }}>{t('openGym')}</h1>
  </>
  ...
  return (
    <div className="narrow" style={wrap}>
      ...
      {webauthnOK() ? <>
        ...
        <div style={{ height: 10 }} />
      </> : <div className="card small muted" style={{ textAlign: 'start' }}>{t("This browser doesn't support passkeys — you can still use openGym locally on this device.")}</div>}
